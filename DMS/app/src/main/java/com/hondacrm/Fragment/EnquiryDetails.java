...
public class EnquiryDetails extends Fragment {
    ...
    String contactId, contactName, contactNumber, categoryId, categoryName, modelNameId, modelName, variantId, variantName, colorId, colorName, enquiryId, enquiryName, statusId, statusName = "Open", purchaseNameId, purchaseName,
            sourceId, sourceName, stageId = "2", stageName = "", customerTypeId, customerType, branchId, branchName, financeTypeId="0", financeTypeName, financierId="0", financierName;
    String branchEnquiryNumber, branchEnquiryName, selectedEnquiryId;
    //Select Date
    Calendar calender;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_enquiry_details, container, false);
        ButterKnife.bind(this, view);
        MainPage.title.setText("Move To Quotation");
    ...
    private void updateStatus() {
        ...
        Call<String> call = Api.getClient().updateEnquiryStatus(enquiryId, textView.getText().toString());
                    ...
                    if (modelColorResponseList.size() > 0) {
                        ...
                        try {
                            ...
                            if (colorId != null) {
                                ...
                                spinners.get(4).setSelection(spinnerPosition);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                ...
                if (response.isSuccessful()) {
                    ...
                    if (modelVariantResponseList.size() > 0) {
                        ...
                        try {
                            ...
                            if (variantName != null) {
                                int spinnerPosition = adapter.getPosition(variantName);
                                spinners.get(3).setSelection(spinnerPosition);
                                getModelColorList(variantId);
                                getModelPriceList(variantId);
                            }
                        } catch (Exception e) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (modelNameResponseList.size() > 0) {
                        ...
                        try {
                            ...
                            if (modelName != null) {
                                int spinnerPosition = adapter.getPosition(modelName);
                                spinners.get(2).setSelection(spinnerPosition);
                                getModelVariantList(modelNameId);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                ...
                if (response.isSuccessful()) {
                    ...
                    if (sourceResponseList.size() > 0) {
                        ...
                        try {
                            ...
                            if (sourceId != null) {
                                int spinnerPosition = adapter.getPosition(sourceId);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (enquiryResponseList.size() > 0) {
                        ...
                        try {
                            ...
                            spinners.get(7).setSelection(getIndex(spinners.get(7), "" + enquiryId));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
            ...
            public void onResponse(Call<List<CategoryResponse>> call, Response<List<CategoryResponse>> response) {
                ...
                if (categoryResponseList.size() > 0) {
                    ...
                    try {
                        ...
                        spinners.get(1).setSelection(getIndex(spinners.get(1), "" + categoryName));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
