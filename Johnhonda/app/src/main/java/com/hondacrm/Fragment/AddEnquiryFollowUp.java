...
public class AddEnquiryFollowUp extends Fragment {
    ...
    String enquiryId, followUpId, followUpName, feedBackId, feedBackName, statusId, statusName;
    //Select Date
    Calendar calender;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_add_follow_up, container, false);
    ...
    private void addEnquiryFollowUP() {
